import 'package:dw11_barbershop/src/core/constants/local_storage_keys.dart';
    ...
    switch (loginResult) {
      ...
      case Failure(:final exception):
        return switch (exception) {
          AuthError() =>
            Failure(ServiceException(message: 'Erro a realizar login')),
          AuthUnauthorizedException() =>
            Failure(ServiceException(message: 'Email ou senha incorretos')),
        };
    }
  }
}
